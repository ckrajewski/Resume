...
Currently, I’m working within Salesforce, developing a financial services app. The intent of the app is to facilitate the process  that advisors go through when managing client financials. The app sits on top of the Salesforce platform, allowing us to take advantage of the platforms functionality. The aura front end framework was used to present client financials in an visually appealing and intuitive way. Reports could be run by the client to see their data in real time. To learn more about the app, visit the webpage <a href="https://www.salesforce.com/solutions/industries/financial-services/financial-services-cloud/" target="_blank">here</a>.
